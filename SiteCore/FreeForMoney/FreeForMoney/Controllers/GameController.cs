...
namespace FreeForMoney.Controllers
{
    public class GameController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,ReleaseDate,Description,Price,CompanyId")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,ReleaseDate,Description,Price,CompanyId")] Game game)
        {
            if (ModelState.IsValid)
            {
